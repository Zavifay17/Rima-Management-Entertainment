    ...
    bookingForm.addEventListener("submit", (e) => {
        ...
        fetch(bookingForm.getAttribute('action'), {
            ...
            body: JSON.stringify({
                ...
                selectedPackages,
                specialRequests,
                lokasi_lat: document.getElementById('lokasi_lat') ? document.getElementById('lokasi_lat').value || null : null,
                lokasi_lng: document.getElementById('lokasi_lng') ? document.getElementById('lokasi_lng').value || null : null,
                lokasi_alamat: document.getElementById('lokasi_alamat') ? document.getElementById('lokasi_alamat').value || null : null
            })
        })
        .then(response => {
