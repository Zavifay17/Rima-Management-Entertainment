...
@section('title', 'Tambah Driver Logistik')
...
<div class="page-header">
    <div class="page-title">
        ...
        <p>Registrasikan driver logistik baru untuk dapat menggunakan aplikasi driver.</p>
    </div>
</div>
    ...
    <div class="glass-card">
        <form action="{{ route('admin.driver.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama') }}" placeholder="Contoh: Ahmad Subardjo" required>
                @error('nama')
            ...
            <div class="form-group">
                ...
                <input type="text" name="username" id="username" class="form-control @error('username') is-invalid @enderror" value="{{ old('username') }}" placeholder="Contoh: driver_ahmad" required>
                @error('username')
                    <span class="validation-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="no_hp" id="no_hp" class="form-control @error('no_hp') is-invalid @enderror" value="{{ old('no_hp') }}" placeholder="Contoh: 081234567890" required>
                @error('no_hp')
                    <span class="validation-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <select name="status_aktif" id="status_aktif" class="form-control @error('status_aktif') is-invalid @enderror" required>
                    <option value="1" {{ old('status_aktif', '1') == '1' ? 'selected' : '' }}>Aktif (Bisa Menerima Tugas)</option>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fa-solid fa-floppy-disk"></i> Simpan Driver
                </button>
            </div>
        </form>
    </div>
