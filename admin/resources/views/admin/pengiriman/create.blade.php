...
@section('title', 'Buat Tugas Pengiriman')
...
<div class="page-header">
    <div class="page-title">
        ...
        <h1>Buat Tugas Pengiriman</h1>
        <p>Buat tugas pengantaran atau penjemputan baru agar bisa dipilih oleh Driver secara mandiri.</p>
    </div>
</div>
...
<div class="form-container">
    <div class="glass-card">
        <form action="{{ route('admin.pengiriman.store') }}" method="POST">
            ...
            <!-- Catatan: Driver tidak dialokasikan di sini karena driver akan mengklaim tugas secara mandiri lewat aplikasi HP -->
