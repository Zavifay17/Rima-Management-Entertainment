            ...
            <table>
                ...
                <tbody>
                    @foreach($pengirimans as $pengiriman)
                        <tr>
                            <td>
                                <a href="{{ route('admin.pengiriman.show', $pengiriman->id_pengiriman) }}" class="order-link"><strong>#{{ $pengiriman->id_pengiriman }}</strong></a>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="driver-badge">
                                    ...
                                    @else
                                        <i class="fa-solid fa-users-viewfinder" style="color: var(--warning);"></i>
                                        <span style="color: var(--warning); font-weight: 700; font-size: 0.85rem; background: rgba(245, 158, 11, 0.1); padding: 0.2rem 0.5rem; border-radius: 6px; border: 1px solid rgba(245, 158, 11, 0.2);">
                                            Terbuka (Self-Assign)
                                        </span>
                                    @endif
                                </div>
                            ...
                            <td style="text-align: right;">
                                <a href="{{ route('admin.pengiriman.show', $pengiriman->id_pengiriman) }}" class="btn-detail">
