...
<div class="page-header">
    <div class="page-title">
        <h1>Dasbor {{ session('admin_role') === 'superadmin' ? 'Superadmin' : 'Admin' }} RME</h1>
                    ...
                    <div class="delivery-item">
                        <div class="delivery-header">
                            <span class="driver-name">
                                @if($delivery->driver)
                                    <i class="fa-solid fa-user-gear"></i> {{ $delivery->driver->nama }}
                                @else
                                    <i class="fa-solid fa-users-viewfinder" style="color: #f59e0b;"></i> <span style="color: #f59e0b; font-weight: 700;">Terbuka (Self-Assign)</span>
                                @endif
                            </span>
                        ...
                        <div class="delivery-info">
                            ...
                            <span>
                                @if($delivery->status_tugas === 'pending')
                                    @if(!$delivery->id_driver)
                                        <span style="color: #f59e0b; font-weight: 700;">Menunggu Klaim</span>
                                    @else
                    ...
                    <div class="day-tasks">
                        ...
                        @foreach($dayTasks as $task)
                            <a href="{{ route('admin.order.show', $task->order->id_order) }}" style="text-decoration: none;">
                                <div class="task-pill {{ $task->tipe_tugas === 'Antar' ? 'task-antar' : 'task-jemput' }}" title="Driver: {{ $task->driver->nama ?? 'Belum Ditugaskan' }}&#10;Tugas: {{ $task->tipe_tugas }}">
                                    <strong>#{{ $task->order->id_order }}</strong> - {{ $task->tipe_tugas }} ({{ $task->driver ? 'Driver' : 'Terbuka' }})
                                </div>
                            </a>
                        @endforeach
                    </div>
