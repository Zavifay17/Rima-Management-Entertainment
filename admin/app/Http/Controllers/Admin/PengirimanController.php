...
class PengirimanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.pengiriman.index')
            ->with('success', 'Tugas pengiriman berhasil dibuat dan siap diambil oleh Driver!');
    }
    ...
    /**
     * Tampilkan detail tugas pengiriman termasuk bukti foto dokumentasi.
     */
    public function show($id)
    {
        ...
        $photos = [];
        if (!empty($pengiriman->bukti_foto_url)) {
            if (str_contains($pengiriman->bukti_foto_url, ',')) {
                $photos = explode(',', $pengiriman->bukti_foto_url);
            } else {
                $photos = [$pengiriman->bukti_foto_url];
            }
        }

        return view('admin.pengiriman.show', compact('pengiriman', 'photos'));
    }
}
