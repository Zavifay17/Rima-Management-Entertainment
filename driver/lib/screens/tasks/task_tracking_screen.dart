...
class _TaskTrackingScreenState extends State<TaskTrackingScreen> {
  ...
  List<_StepData> _getSteps(TaskModel task) {
    final isDelivery = task.type == 'delivery';
    return [
      _StepData(
        status: 'accepted',
        label: 'Tugas Diterima',
        description: isDelivery
            ? 'Tugas pengiriman telah diterima oleh driver'
            : 'Tugas penjemputan telah diterima oleh driver',
      ...
      _StepData(
        ...
        label: 'Alat Diambil',
        description: isDelivery
            ? 'Alat event telah diambil dari gudang'
            : 'Alat event telah diambil dari lokasi event',
      ...
      _StepData(
        ...
        description: isDelivery
            ? 'Driver sedang menuju lokasi event'
            : 'Driver sedang menuju gudang',
      ...
      _StepData(
        ...
        description: isDelivery
            ? 'Driver telah tiba di lokasi event'
            : 'Driver telah tiba di gudang',
      ...
      appBar: AppBar(
        ...
        leading: GestureDetector(
          ...
          child: Container(
            ...
            child:
                const Icon(Icons.arrow_back_rounded, color: AppColors.grey700),
          ),
        ),
      ),
      body: Column(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...(steps.asMap().entries.map((entry) {
                    ...
                    final isCurrent =
                        currentStep == stepIndex - 1 && !isDone && i != 4;
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Anda telah menyelesaikan tugas ini',
                              style: AppTextStyles.bodySmall
                                  .copyWith(color: AppColors.success)),
                        ],
                      ),
