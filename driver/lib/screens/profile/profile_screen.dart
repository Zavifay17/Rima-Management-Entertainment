                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Kendaraan', style: AppTextStyles.bodySmall),
                              Text(
  ...
  void _showLogoutDialog(BuildContext context, AuthProvider auth) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content:
            const Text('Anda akan logout dari aplikasi EventDriver. Yakin?'),
        actions: [
          TextButton(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                      ...
                      child: Stack(
                        children: [
                          CircleAvatar(
                            ...
                            backgroundImage: selectedPhotoBase64 != null &&
                                    selectedPhotoBase64!.isNotEmpty
                                ? MemoryImage(base64Decode(selectedPhotoBase64!
                    ...
                    // Vehicle Type Input
                    Text('Tipe Kendaraan', style: AppTextStyles.labelLarge),
                    const SizedBox(height: 8),
                    TextField(
                      controller: vehicleTypeController,
                      decoration: InputDecoration(
                        hintText: 'Contoh: Pickup Truck, Box, L300',
                    ...
                    // Vehicle Plate Input
                    Text('Plat Nomor', style: AppTextStyles.labelLarge),
                    const SizedBox(height: 8),
                    TextField(
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          ...
                          final success = await auth.updateProfile(
                            ...
                            phone: phone,
                            photoBase64:
                                isPhotoChanged ? selectedPhotoBase64 : null,
                          ...
                          if (parentContext.mounted) {
                            Navigator.pop(
                                parentContext); // Close loading dialog
                            if (success) {
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 4),
            Text(
                'Deskripsi: Aplikasi manajemen pengiriman dan pick up alat event untuk driver profesional.',
                style: AppTextStyles.bodySmall),
          ],
        ),
        actions: [
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text(
                'Data profil Anda telah berhasil disimpan dan diperbarui.',
