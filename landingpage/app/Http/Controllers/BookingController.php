...
class BookingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'locationAddress.required' => 'Alamat lokasi penyewaan wajib diisi.',
            'locationAddress.max' => 'Alamat terlalu panjang (maksimal 500 karakter).',
        ...
        // 2. Server-side Package Mapping (sesuai ID di database lokal layanan_sewa)
        $prices = [
            ...
            'stage-10x8'      => ['id' => 12, 'price' => 6500000],
            'stage-mini'      => ['id' => 13, 'price' => 70000,  'is_dynamic'     => true],
            'rigging-balokan' => ['id' => 14, 'price' => 150000, 'is_dynamic_qty' => true],
        ...
        $lightCustomData = [
            ['id' => 15, 'qty' => (int) $request->input('qty_light_parled', 0),        'price' => 200000],
            ['id' => 16, 'qty' => (int) $request->input('qty_light_beam', 0),          'price' => 450000],
            ['id' => 17, 'qty' => (int) $request->input('qty_light_bola', 0),          'price' => 150000],
            ['id' => 18, 'qty' => (int) $request->input('qty_light_fresnel', 0),       'price' => 350000],
            ['id' => 19, 'qty' => (int) $request->input('qty_light_tembakputih', 0),   'price' => 150000],
            ['id' => 20, 'qty' => (int) $request->input('qty_light_tembakkuning', 0),  'price' => 150000],
            ['id' => 21, 'qty' => (int) $request->input('qty_light_smoke500', 0),      'price' => 450000],
            ['id' => 22, 'qty' => (int) $request->input('qty_light_smoke300', 0),      'price' => 300000],
        ];
