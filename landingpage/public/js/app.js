...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const validateForm = () => {
        ...
        if (!locationAddress.value.trim()) {
            setError(locationAddress, "locationAddressError", true, "Alamat lokasi acara wajib diisi.");
        } else {
            setError(locationAddress, "locationAddressError", false);
        }
    ...
    bookingForm.addEventListener("submit", (e) => {
        ...
        .then(res => {
            ...
            if (res.success) {
                ...
                waText += `*Lokasi Acara:* ${locationAddress}\n`;
        ...
        .catch(err => {
            ...
            if (err.status === 422 && err.data && err.data.errors) {
                ...
                if (errors.locationAddress) {
                    setError(document.getElementById("locationAddress"), "locationAddressError", errors.locationAddress[0]);
                }
